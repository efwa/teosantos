...
Cargo.Event.on('element_resizer_init', function(plugin) {
    plugin.setOptions({
        cargo_refreshEvents: ['inline-editor-load-complete', 'show_index_complete', 'pagination_complete', 'page_load_complete', 'inspector_preview', 'page_collection_reset', 'direct_link_loaded'],
